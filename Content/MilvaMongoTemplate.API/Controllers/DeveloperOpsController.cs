...
namespace MilvaMongoTemplate.API.Migrations
{
    /// <summary>
    ...
    public class DeveloperOpsController : ControllerBase
    {
        ...
        private readonly RoleManager<MilvaMongoTemplateRole> _roleManager;
        ...
        public DeveloperOpsController(MilvaMongoTemplateUserManager userManager,
                                      ...
                                      RoleManager<MilvaMongoTemplateRole> roleManager)
        {
