...
namespace MilvaMongoTemplate.API.Helpers
{
    ...
    public class MilvaMongoTemplateLogger : IMilvaLogger
    {
        ...
        /// <summary>
        /// Initializes new instance of <see cref="MilvaMongoTemplateLogger"/>
        /// </summary>
        /// <param name="milvaMailSender"></param>
        public MilvaMongoTemplateLogger(IMilvaMailSender milvaMailSender)
        {
